...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		//because this better (above is still usable lol)
		gfDance.animation.addByPrefix('danceLeft', 'gfLeftDance', 24, false);
		gfDance.animation.addByPrefix('danceRight', 'gfRightDance', 24, false);
